...
export interface RouteContext {
    ...
    decisionJournalRepo: PgDecisionJournalRepository;
    recommendationRepo?: PgRecommendationRepository;
    recommendationVersionRepo?: PgRecommendationVersionRepository;
    // Storage
