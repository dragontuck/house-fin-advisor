...
import { EntityId, FinancialDocument, DocumentProcessingStatus, DocumentSourceType } from "@house-fin/contracts";
 ...
 */
export function generateObjectStorageKey(
...
): { errorCode: string; userMessage: string } | null {
 ...
 */
export const VALID_STATUS_TRANSITIONS: Record<DocumentProcessingStatus, DocumentProcessingStatus[]> = {
    ...
    [DocumentProcessingStatus.VALIDATION_FAILED]: [DocumentProcessingStatus.UPLOADED], // Retry
    [DocumentProcessingStatus.IDENTIFYING]: [
    ...
    [DocumentProcessingStatus.PARSE_FAILED]: [DocumentProcessingStatus.PARSING], // Retry with new parser
    [DocumentProcessingStatus.NORMALIZING]: [
