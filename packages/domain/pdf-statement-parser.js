...
exports.PdfStatementParser = void 0;
 ...
 */
async function extractTextFromPdf(pdfBuffer, maxPages = 50) {
 ...
 */
function extractStatementMetadata(text) {
...
class PdfStatementParser {
    ...
    async canParse(input) {
        if (input.sourceType !== contracts_1.DocumentSourceType.PDF) {
            return {
                matches: false,
                confidence: 0,
    ...
    async parse(input) {
        ...
        try {
            ...
            if (extractedText.trim()) {
                extractionMethods.push(contracts_1.ExtractionMethod.TEXT);
            }
        }
        catch (error) {
            extractedText = "";
        ...
        if (extractedText.trim()) {
            ...
            if (hasTableStructure) {
                extractionMethods.push(contracts_1.ExtractionMethod.TABLE);
            }
        }
        ...
        if (!extractedText.trim()) {
            ...
            throw new Error("PDF appears to be scanned (no text layer detected). OCR processing requires additional setup.");
        }
        ...
        while ((match = linePattern.exec(extractedText)) !== null) {
            try {
                ...
                transactions.push({
                    ...
                    sourceReference: {
                        pageNumber: 1,
                        extractionMethod: contracts_1.ExtractionMethod.TEXT,
                        confidence: 0.8,
                    },
                });
                rowNumber++;
        ...
        return {
            ...
            sourceType: contracts_1.DocumentSourceType.PDF,
            detectedFormat: {
...
exports.PdfStatementParser = PdfStatementParser;
//# sourceMappingURL=pdf-statement-parser.js.map